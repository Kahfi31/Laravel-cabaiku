...
class ArtikelJenisController extends Controller
{
    /**
    ...
    {
        $articles = Article::where('category', 'jenis')->get();
        return view('jenis.index', compact('articles'));
    }
    ...
    public function store(Request $request)
{
    ...
    return redirect()->route('jenis.index')->with('success', 'Artikel berhasil ditambahkan.');
    }
    ...
    public function edit($id)
    {
        ...
        return view('jenis.edit', compact('article'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('jenis.index')->with('success', 'Artikel berhasil diperbarui');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('jenis.index')->with('success', 'Artikel berhasil dihapus.');
    }
    ...
    {
        $article = Article::findOrFail($id);
        return view('jenis.show', compact('article'));
    }
}
